...
img1 = cv.imread('RGBD dataset/000000029/im_0.jpg')
img2 = cv.imread('RGBD dataset/000000029/im_1.jpg')
poc, points1, points2 = begin(img1, img2)
dimg2 = cv.imread('RGBD dataset/000000029/depth_1.jpg')
...
for i in range(11):
	...
	if len(hom_list[i])>=4:
		...
		try:
			H.append((i,ransa(np.asarray(hom_list[i-1]))))
		except:
			continue

image = warpimage(img1, img2,dimgf, 5000,5000,10000,10000,H,1)
cv.imwrite('000000029_with_depth.jpg',image)
